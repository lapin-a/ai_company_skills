...
- **국내 트랙:** [kr/coverage-log.md](kr/coverage-log.md) — 국내 라운드 1~5 · KRX 백필, 국내 요약표, 국내 전용 규칙(대상 선정·보고서 선택·파서·시장데이터), 국내 진행 중 사항
...
- 국내 + 미국 누적: **376개 기업**, 값 있는 칸 **121,003** · 데이터 없음 **1,823** · 미확인 **1,254**. (데이터셋 직접 집계, 2026-09-21 국내 라운드 6~10 + 재작성 반영 전 라운드 재생성 반영)
  - 재작성 반영 칸: 국내 449 · 미국 709. 기록은 각 데이터셋 옆 `…-restated.csv` (아래 진행 중 사항 5번).
