...
10. **미국 트랙 미결 사항** (us-round1-log.md 1·5절)
    ...
    - ~~XOM 승계 CIK 처리, V 시총 확인~~ → 라운드 2에서 처리했다(us-round2-log.md 2~4절). ~~UNH 금융 판정~~ → 일반 트랙에 넣기로 했다(2026-09-22, 16번 항목).
    ...
    - ~~S&P500 전체 분모 확정~~ → 회사 500곳(2026-09-22, 16번 항목).
...
16. ~~SPY 476~504위 업종 판정·미확인 407칸 진단~~ → **완료 (2026-09-21).** 상세 [us-round17-30-log.md](logs/us-round17-30-log.md) 10·11절
    ...
    - 504행 분류 완료. 기준 충족·미수집 20곳 중 **BE·ILMN·P·LDOS 4곳은 후보 풀 누락**. ~~기준 재수립 초안 결정 대기~~ → **결정 (대표, 2026-09-22): S&P500 모든 기업(회사 500곳)을 대상으로 한다.** 이력 기준은 없앤다. 금융·리츠는 금융 항목 세트를 쓰는 별도 트랙으로 모으고, 건강보험 5곳은 일반 트랙에 둔다(UNH 금융 판정은 이것으로 닫음). 남은 대상은 약 일반 33곳 · 금융 93곳이고, 건강보험 5곳이 98곳 안에 모두 들어 있는지는 다음 라운드 대조 때 확인한다. 상세 [us-round17-30-log.md](logs/us-round17-30-log.md) 11절
