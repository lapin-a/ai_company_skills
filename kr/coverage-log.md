...
- **2010년대 백필 (진행 중):** [backfill-2010s-log.md](logs/backfill-2010s-log.md) — 수집 기간 2010Q1~로 확장, 옛 목차 보고서(2014년 이전) 파서 보완 8종, 새 결측 라벨 제안. 데이터셋은 아직 2019Q1~
...
- **옛 목차 보고서(2014년 이전, "XI. 재무제표 등" 장) 전용 (2026-09-21, 백필 진행 중):** "연결" 제목 표만 인정, 그 분기말 날짜가 붙은 표만 인정, 대차대조표·소수주주지분 인식, "누계"도 누적 열, 사업보고서는 첫 열이 연간, 누적 열만 있는 반기·3분기는 누적차감. 상세 [backfill-2010s-log.md](logs/backfill-2010s-log.md) 2절.
...
16. **2010년대 백필 — 국내 (2026-09-21 시작)** — 코드 수정·표본 검증 끝, 데이터셋 재생성 전. 공통 결정 사항은 [../coverage-log.md](../coverage-log.md) 16번.
    - 재생성 전에 고칠 것: K-GAAP 사업보고서의 연결재무제표가 "III. 재무에 관한 사항" 장에 있는 경우(현대차 2010Q4가 `연결 미수록`으로 잘못 표시된다), LG화학 2010년 재무상태표 미인식.
    - 상세 [backfill-2010s-log.md](logs/backfill-2010s-log.md) 6절.
