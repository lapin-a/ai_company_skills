...
- 대형주 대비 진행률: **76 / 100 = 76.0%** (라운드 1~10 완료). 목록 확정됨(`largecap100.csv`, 기준일 2026-09-16, 100위 대덕전자 5.03조원).
- 구성: 비금융 81 (수집 완료 76, **수집 불가 5**) · 금융 19 (항목 체계 준비 후 수집). 비금융 기준 진행률 76 / 81 = 93.8%.
