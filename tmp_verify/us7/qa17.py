"""라운드 17~30 QA 사전 점검(69곳 일괄): 중복 · CIK 일치 · 영업이익 태그 · 분기 라벨 겹침 · 보고기간."""
...
rows = json.load(open("tmp_verify/us7/us_r17.json", encoding="utf-8"))["rows"]
...
json.dump([[r.get("name"), r["ticker"], r["cik"]] for r in top],
          open("tmp_verify/us7/top17.json", "w", encoding="utf-8"), ensure_ascii=False, indent=1)
print("saved tmp_verify/us7/top17.json")
